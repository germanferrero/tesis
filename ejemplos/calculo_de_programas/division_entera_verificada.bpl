...
function {:inline} read(H: Heap, r: ref, f: Field) : Box
{
  H[r][f]
}

function {:inline} update(H: Heap, r: ref, f: Field, v: Box) : Heap
{
  H[r := H[r][f := v]]
}
...
function MultiSet#FromSeq(Seq) : MultiSet
uses {
...
axiom (forall m: Map, m': Map :: 
  { Map#Equal(m, m') } 
  Map#Equal(m, m')
     <==> (forall u: Box :: Map#Domain(m)[u] == Map#Domain(m')[u])
       && (forall u: Box :: 
        Map#Domain(m)[u] ==> Map#Elements(m)[u] == Map#Elements(m')[u]));
       ...
       <==> (forall bx0: Box :: 
        ...
        $IsBox(bx0, t0) && $IsAllocBox(bx0, t0, h) && Requires1(t0, t1, h, f, bx0)
           ==> (forall r: ref :: 
            ...
            r != null && Reads1(t0, t1, h, f, bx0)[$Box(r)]
  ...
  $IsGoodHeap(h)
     ==> ($IsAlloc(f, Tclass._System.___hFunc0(t0), h)
       <==> Requires0(t0, h, f)
         ==> (forall r: ref :: 
          { Reads0(t0, h, f)[$Box(r)] } 
          r != null && Reads0(t0, h, f)[$Box(r)] ==> $Unbox(read(h, r, alloc)): bool)));
...
procedure {:verboseName "division_entera (well-formedness)"} CheckWellFormed$$_module.__default.division__entera(x#0: int, y#0: int) returns (q#0: int, r#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "division_entera (call)"} Call$$_module.__default.division__entera(x#0: int, y#0: int) returns (q#0: int, r#0: int);
  // user-defined preconditions
  requires {:id "id4"} x#0 > 0;
  requires {:id "id5"} y#0 > 0;
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
  ensures {:id "id6"} x#0 == Mul(q#0, y#0) + r#0;
  ensures {:id "id7"} LitInt(0) <= r#0;
  ensures {:id "id8"} r#0 < y#0;
...
procedure {:verboseName "division_entera (correctness)"} Impl$$_module.__default.division__entera(x#0: int, y#0: int)
   returns (defass#q#0: bool, q#0: int, defass#r#0: bool, r#0: int, $_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id9"} x#0 > 0;
  requires {:id "id10"} y#0 > 0;
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
  ensures {:id "id11"} x#0 == Mul(q#0, y#0) + r#0;
  ensures {:id "id12"} LitInt(0) <= r#0;
  ensures {:id "id13"} r#0 < y#0;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
    $o != null && $Unbox(read(old($Heap), $o, alloc)): bool
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "division_entera (correctness)"} Impl$$_module.__default.division__entera(x#0: int, y#0: int)
   returns (defass#q#0: bool, q#0: int, defass#r#0: bool, r#0: int, $_reverifyPost: bool)
{
  ...
  var $decr$loop#00: int;
    ...
    // AddMethodImpl: division_entera, Impl$$_module.__default.division__entera
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    assume {:captureState "ejemplo_19_1_division_entera_verificada.dfy(4,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/gferrero/tesis/ejemplos/calculo_de_programas/ejemplo_19_1_division_entera_verificada.dfy(5,7)
    assume true;
    assume true;
    q#0 := LitInt(0);
    defass#q#0 := true;
    assume {:captureState "ejemplo_19_1_division_entera_verificada.dfy(5,10)"} true;
    // ----- assignment statement ----- /home/gferrero/tesis/ejemplos/calculo_de_programas/ejemplo_19_1_division_entera_verificada.dfy(6,7)
    assume true;
    assume true;
    r#0 := x#0;
    defass#r#0 := true;
    assume {:captureState "ejemplo_19_1_division_entera_verificada.dfy(6,10)"} true;
    // ----- while statement ----- /home/gferrero/tesis/ejemplos/calculo_de_programas/ejemplo_19_1_division_entera_verificada.dfy(7,5)
    ...
    while (true)
      free invariant true;
      invariant {:id "id20"} $w$loop#0 ==> x#0 == Mul(q#0, y#0) + r#0;
      invariant {:id "id21"} $w$loop#0 ==> r#0 >= LitInt(0);
      ...
      free invariant r#0 - y#0 <= $decr_init$loop#00;
    {
        ...
        // ----- assignment statement ----- /home/gferrero/tesis/ejemplos/calculo_de_programas/ejemplo_19_1_division_entera_verificada.dfy(11,11)
        assume true;
        ...
        // ----- assignment statement ----- /home/gferrero/tesis/ejemplos/calculo_de_programas/ejemplo_19_1_division_entera_verificada.dfy(12,11)
        assume true;
        ...
        // ----- loop termination check ----- /home/gferrero/tesis/ejemplos/calculo_de_programas/ejemplo_19_1_division_entera_verificada.dfy(7,5)
